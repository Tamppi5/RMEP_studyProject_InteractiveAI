...
> In this task, you're going to be answering a set of 20 questions about logical reasoning. You will use ChatGPT as we are especially interested in your abilities to use AI to solve these problems.
...
> Compared to other participants in this study, how would you rate your general logical reasoning ability when using the help of AI? Marking 90% means you are better than 90% of participants, marking 10% means you are better than only 10%, and marking 50% means that you will perform better than half of the participants.

    $slider; 0; 100; Better than 0%; Better than 100%

> Using the AI, how many of the 20 logical reasoning problems do you think you will solve correctly?

    $number

> Without AI use, how many of the 20 logical reasoning problems do you think you would solve correctly?

    $number

> Compared to other AI systems, how would you estimate the AI system's logical reasoning ability? Marking 90% means it performs better than 90% of ofther systems, marking 10% means it performs better than only 10%, and marking 50% means that the AI system will perform better than half of other AI systems.

    $slider; 0; 100; Better than 0%; Better than 100%

> On its own, how many of the 20 logical reasoning problems do you think the AI would solve correctly?
...
> In the following task you have to use AI software to solve logical reasoning problems. We are especially interested in your abilities to use ChatGPT to solve these problems.

> Use the chat view on the right side to converse with ChatGPT. After each problem, you will be asked how confident you were in your performance.

> We will record your entire conversation at the end of the study.
...
> The task part of the study is now over. We still have some questions regarding your experiences and opinions.

#

> Please describe how you used the AI Chatbot
...
> Using the AI, how many of the 20 logical reasoning problems do you think solved correctly?

    $number

> Without AI use, how many of the 20 logical reasoning problems do you think you would have solved correctly?

    $number

> Compared to other AI systems, how would you estimate the AI system's logical reasoning ability? Marking 90% means it performed better than 90% of ofther systems, marking 10% means it performed better than only 10%, and marking 50% means that the AI system performed better than half of other AI systems.

    $slider; 0; 100; Better than 0%; Better than 100%

> On its own, how many of the 20 logical reasoning problems do you think the AI would have solved correctly?
...
> ... describe how machine learning models are trained, validated and tested.
...
> ... explain how rule-based systems differ from machine learning systems.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain how AI applications make decisions

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain how 'reinforcement learning' works on a basic level (in the context of machine learning).

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain the difference between general (or strong) and narrow (or weak) artificial intelligence.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain how sensors are used by computers to collect data that can be used for AI purposes.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain what the term 'artificial neural network' means.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain how machine learning works at a general level.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain the difference between 'supervised learning' and 'unsupervised learning' (in the context of machine learning).
...
> ... describe how some artificial intelligence systems can act in their environment and react to their environment. 
...
> ... evaluate whether media representations of AI (e.g., in movies or video games) go beyond the current capabilities of AI technologies.

    $likert; 1; 7; strongly disagree; strongly agree

# I can ...

> ... explain why data privacy must be considered when developing and using artificial intelligence applications.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain why data security must be considered when developing and using artificial intelligence applications.
...
> ... describe risks that may arise when using artificial intelligence systems.
...
> ... describe potential legal problems that may arise when using artificial intelligence.

    $likert; 1; 7; strongly disagree; strongly agree

> ... critically reflect on the potential impact of artificial intelligence on individuals and society.

    $likert; 1; 7; strongly disagree; strongly agree

> ... describe why humans play an important role in the development of artificial intelligence systems.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain why data plays an important role in the development of artificial intelligence.

    $likert; 1; 7; strongly disagree; strongly agree

> ... decribe what artificial intelligence is.

    $likert; 1; 7; strongly disagree; strongly agree

# I can ...

> ... give examples from my daily life (personal or professional) where I might be in contact with artificial intelligence.

    $likert; 1; 7; strongly disagree; strongly agree

> ... name examples of technical applications that are supported by artificial intelligence.
...
> ... assess if a problem in my field can and should be solved with artificial intelligence methods.

    $likert; 1; 7; strongly disagree; strongly agree

> ... name applications in which AI-assisted natural language processing/understanding is used.

    $likert; 1; 7; strongly disagree; strongly agree

> ... explain why AI has recently become increasingly important.

    $likert; 1; 7; strongly disagree; strongly agree

> ... critically evaluate the implications of artificial intelligence applications in at least one subject area.
